export class DistanceHelper {
   ...
   */
  static filterByDistance(drivers: any[], lat: number, lng: number, maxDistance: number): any[] {
    return drivers
      .map(driver => ({
        ...driver,
        distance: this.calculateDistance(lat, lng, driver.lastLatitude, driver.lastLongitude),
      }))
